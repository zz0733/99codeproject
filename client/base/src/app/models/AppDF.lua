...
-- 大厅视图
appdf.PLAZA_VIEW_SRC						= appdf.CLIENT_SRC .. "plaza.views.layer.plaza." 
...
appdf.BASE_GAME = 
{
 ...
 --大厅地址
appdf.HallAdress_Index = 1
appdf.Hall_Address = {}
function appdf.getLogonIP()
   return appdf.Hall_Address[appdf.HallAdress_Index]
end

function appdf.swichLogonIp()
   appdf.HallAdress_Index = appdf.HallAdress_Index + 1
   if appdf.HallAdress_Index > #appdf.Hall_Address then
        appdf.HallAdress_Index = 1
   end
end

 --游戏地址
appdf.GameAdress_Index = 1
appdf.Game_Address = {}
function appdf.getGameIP()
   return appdf.Game_Address[appdf.GameAdress_Index]
end

function appdf.swichGameIp()
   appdf.GameAdress_Index = appdf.GameAdress_Index + 1
   if appdf.GameAdress_Index > #appdf.Game_Address then
        appdf.GameAdress_Index = 1
   end
end
...
--判断table是否为空
function appdf.table_is_empty(t)
