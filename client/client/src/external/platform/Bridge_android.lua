...
function Bridge_android.testRecordService()
    local args = { }
    local sigs = "()V" 
    local ok,ret = luaj.callStaticMethod(BRIDGE_CLASS,"testRecordService",args,sigs)
    if not ok then
        local msg = "luaj error:" .. ret
        print(msg)  
        return false, msg   
...
function Bridge_android.isNetworkAvailable()
    local sigs = "()Z"
    local ok,ret = luaj.callStaticMethod(BRIDGE_CLASS, "isNetworkAvailable", {}, sigs)
    if not ok then
        local msg = "luaj error:" .. ret
        print(msg)  
        return false, msg  
...
function Bridge_android.goToSetting()
    local sigs = "()V"
    local ok,ret = luaj.callStaticMethod(BRIDGE_CLASS, "goToSetting", {}, sigs)
    if not ok then
        local msg = "luaj error:" .. ret
        print(msg)  
        return false, msg  
...
function Bridge_android.getLaunchData()
    local sigs = "()Ljava/lang/String;"
    local ok,ret = luaj.callStaticMethod(BRIDGE_CLASS, "getLaunchData", {}, sigs)
    if not ok then
        local msg = "luaj error:" .. ret
        print(msg)  
        return ""  
...
function Bridge_android.getCopyBoardData( callback )
    local args = { callback }
    local sigs = "(I)V"
    local ok,ret = luaj.callStaticMethod(BRIDGE_CLASS, "getCopyBoardData", args, sigs)
    if not ok then
        local msg = "luaj error:" .. ret
        print(msg)  
        return ""  
...
function Bridge_android.getClientPackageName()
    local sigs = "()Ljava/lang/String;"
    local ok,ret = luaj.callStaticMethod(BRIDGE_CLASS, "getClientPackageName", {}, sigs)
    if not ok then
        local msg = "luaj error:" .. ret
        print(msg)  
        return ""  
...
function Bridge_android.getDeviceToken()
    local sigs = "()Ljava/lang/String;"
    local ok,ret = luaj.callStaticMethod(BRIDGE_CLASS, "getDeviceToken", {}, sigs)
    if not ok then
        local msg = "luaj error:" .. ret
        print(msg)  
        return ""  
...
function Bridge_android.systemCall( szTel )
    local args = { szTel }
    local sigs = "(Ljava/lang/String;)V" 
    local ok,ret  = luaj.callStaticMethod(BRIDGE_CLASS,"systemCall",args,sigs)
    if not ok then
        local msg = "luaj error:" .. ret
        print(msg)  
        return 0, msg   
