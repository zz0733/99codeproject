...
function FloatMessage:initAll()
    ...
    cc.exports.TimerProxy:addTimer(888, handler(self, self.updateTicker),  0.18, -1, false)
end
...
function FloatMessage:uninitUI()
    ...
    cc.exports.TimerProxy:removeTimer(888)
...
function FloatMessage:createColorText(text, node)
    ...
    local re1 = ccui.RichElementText:create(1,cc.c3b(0, 0, 0), 255,text, "fonts/round_body.ttf", 18)
