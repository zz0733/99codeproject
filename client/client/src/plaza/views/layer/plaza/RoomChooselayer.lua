...
function RoomChooseLayer:ctor(scene, param, level)
...
--显示时初始化
function RoomChooseLayer:init(bNeedRoomList)
...
-- 添加响应
function RoomChooseLayer:onButtonClicked(pSender)
    ExternalFun.playClickEffect()
...
function RoomChooseLayer:getRoomList()
...
--处理房间列表
function RoomChooseLayer:handRoomList(data)
    -- 获取房间列表
    self.m_vecRoomList = {}
...
function RoomChooseLayer:onLogonCallBack(result,message)
