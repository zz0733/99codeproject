...
function CBetManager:getUserInfoList()
    return self.m_userplayerList
end
function CBetManager:setUserInfoList(playerlist)
    table.insert(self.m_userplayerList,playerlist)
end 
function CBetManager:getUserInfoListSize()
    return table.nums(self.m_userplayerList)
end
