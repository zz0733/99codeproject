...
local cmd = appdf.req("game.yule.lkby.src" .. ".models.CMD_Game")
...
function FishDataMgr:onDistributeFish(pDistributeFish, bSyncFish)
    ...
    local newFish = {}
    newFish.isAlive = true 
    newFish.path_index = pDistributeFish.path_index     --[3路径ID]
    newFish.fish_kind = pDistributeFish.fish_kind       --[2]本地鱼配表ID
    newFish.fish_id = pDistributeFish.fish_id           --[1]鱼id
