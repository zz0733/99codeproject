...
--local CMsgBaccarat = appdf.req(module_pre..".game.baccarat.proxy.CMsgBaccarat")
...
--    CMsgBaccarat.getInstance():setGameFrame(frameEngine)
...
function GameLayer:SendBet(tab_desk)
