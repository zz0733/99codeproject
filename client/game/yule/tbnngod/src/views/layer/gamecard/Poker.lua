...
function Poker:ctor()
    cc.SpriteFrameCache:getInstance():addSpriteFrames("tbnn/plist/qznn-poker.plist","tbnn/plist/qznn-poker.png")
    self:enableNodeEvents()
    self.m_pathUI = cc.CSLoader:createNode("tbnn/PokerNode.csb")
