...
function ProgressNode:ctor()
    cc.SpriteFrameCache:getInstance():addSpriteFrames("niuniu/plist/twoniuniu.plist","niuniu/plist/twoniuniu.png")
...
function ProgressNode:init()
    self.progress_image = cc.Sprite:createWithSpriteFrameName("game/twoniuniu/gui/gui-tniuniu-progress-timer.png")
