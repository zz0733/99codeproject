...
GameLayer.Res = "game/yule/lhdz/res/"
...
function GameLayer:SendBet(tab,desk)
...
--        self._gameView:Badbetmoney(dataBuffer)
    ...
    elseif sub == "seatinfo" then
        self._gameView:updataSeatinfo(dataBuffer)
    elseif sub == "pong" then
        print("心跳...砰")
    elseif sub == "situp" then
        self._gameView:updataSitup(dataBuffer)
    elseif sub == "sitdown" then
        self._gameView:updataSitdown(dataBuffer)
    else
        print(sub)
    end
end
