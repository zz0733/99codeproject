...
--Author JackyXu
--Desc 大闹天宫鱼路径定义
local resPathBase = "game/monkeyfish/" -- 资源文件基础文件夹路径，避免拷贝文件导致路径错误
local FishRes = 
{
    vecReleaseAnim = {
        --炮
        ...
        --如意金箍棒
        resPathBase .. "effect/ruyijingubangwenzidonghua_buyu/ruyijingubangwenzidonghua_buyu.ExportJson",
        --如意金箍棒
        resPathBase .. "effect/ruyijingubangdonghua_buyu/ruyijingubangdonghua_buyu.ExportJson",
        --万佛朝中文字
        resPathBase .. "effect/wanfochaozhongwenzidonghua_buyu/wanfochaozhongwenzidonghua_buyu.ExportJson",
        --一石三鸟
        resPathBase .. "effect/yishisanniao_buyu/yishisanniao_buyu.ExportJson",
        --一箭双雕
        resPathBase .. "effect/yijianshuangdiao_buyu/yijianshuangdiao_buyu.ExportJson",
        --大闹天宫
        resPathBase .. "effect/danaotiankongyuanpan_buyu/danaotiankongyuanpan_buyu.ExportJson",
        --万佛朝中
        resPathBase .. "effect/wanfocaozhong_buyu/wanfocaozhong_buyu.ExportJson",
        --气泡
        ...
        --无敌风火轮
        resPathBase .. "effect/wudifenghuolun_buyu/wudifenghuolun_buyu.ExportJson",
        resPathBase .. "effect/wudifenghuolunwenzidonghua_buyu/wudifenghuolunwenzidonghua_buyu.ExportJson",
        --镇妖塔
        resPathBase .. "effect/zhengyaota_buyu/zhengyaota_buyu.ExportJson",
        resPathBase .. "effect/zhengyaotawenzidonghua_buyu/zhengyaotawenzidonghua_buyu.ExportJson",
        --定炮
        resPathBase .. "effect/dingpao_buyu/dingpao_buyu.ExportJson",
        --锁定捕鱼
        ...
        --BOSS光环
        resPathBase .. "effect/BOSSguanghuan_buyu/BOSSguanghuan_buyu.ExportJson",
        -- 鱼
        ...
        -- 其他鱼
        resPathBase .. "effect/animals/dashengzhanjian_buyu/dashengzhanjian_buyu.ExportJson",
        resPathBase .. "effect/animals/liandanlu_buyu/liandanlu_buyu.ExportJson",
        resPathBase .. "effect/animals/meirenyu_buyu/meirenyu_buyu.ExportJson",
        resPathBase .. "effect/animals/ruyijingubang_buyu/ruyijingubang_buyu.ExportJson",
        resPathBase .. "effect/animals/sunwukong_buyu/sunwukong_buyu.ExportJson",
        resPathBase .. "effect/animals/yuhuangdadi_buyu/yuhuangdadi_buyu.ExportJson",
    ...
    vecReleaseSound = {
        ...
        resPathBase .. "sound/fish33_1.mp3",
        ...
        resPathBase .. "sound/fish-tx-quanpinzhadan.mp3",
    ...
    --animation
    EFFECT_OF_LOADING = resPathBase .. "effect/srbyloading/srbyloading.ExportJson",
    ...
    PARTICLE_OF_FENGHUOLUN = resPathBase .. "particle/wudifenghuolunbaozha_1_0.plist", --风火轮
    ...
    SOUND_OF_SCREEN     = resPathBase .. "sound/fish-click-screen.mp3",
    ...
    SOUND_OF_FISH = {
        ...
        [33] = resPathBase .. "sound/fish33_1.mp3",
    },
    ...
    SOUND_OF_ZHENGYAOJINGANGTA = resPathBase .. "sound/fish-tx-zhengyaojingangta.mp3", --全局定/镇妖塔
    SOUND_OF_WUDIFENGHUOLUN    = resPathBase .. "sound/fish-tx-wudifenghuolun.mp3", --局部炸弹/无敌风火轮
    SOUND_OF_RUYIJINGUBANG     = resPathBase .. "sound/fish-tx-dinhaishenzhen.mp3",--如意金箍棒(局部炸弹)
    SOUND_OF_WANFOCHAOZONG     = resPathBase .. "sound/fish-tx-quanpinzhadan.mp3",--全屏炸弹/万佛朝宗
    ...
    --FISH_COPY_PATH = "monkeyfish_%d.dat", --新路径(android)
    FISH_COPY_PATH = "monkeyfish_newCurve_%d.dat", --新路径(android)
}
