...
function Poker:ctor()
    cc.SpriteFrameCache:getInstance():addSpriteFrames("4rennn/qznn-poker.plist","4rennn/qznn-poker.png")
    self:enableNodeEvents()
    self.m_pathUI = cc.CSLoader:createNode("4rennn/PokerNode.csb")
