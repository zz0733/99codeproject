...
function GameRoomLayer:fillRoomCellRes()
   self.m_roomCellRes ={
        --低倍场
        {[cell_bg]    = "hbyc.png",
        [cell_title] = "dibeichang.png",
        [cell_icon]  = "brnn_xc_01.png",
        [cell_dTextbg]  = "hbyc_bg1.png"},
        --高倍场
        {[cell_bg]    = "hjha.png",
        [cell_title] = "dibeichang_2.png",
        [cell_icon]  = "brnn_xc_02.png",
        [cell_dTextbg]  = "hjha_bg2.png"},

    }
    self.gameTitle = "brnn_xc_title.png"
end
...
function GameRoomLayer:createScrollRoomList()
    ...
    local nOffX = 160 -- 偏移
    local pos = {ccp(centerX-nOffX,commonY),ccp(centerX+nOffX,commonY)}
