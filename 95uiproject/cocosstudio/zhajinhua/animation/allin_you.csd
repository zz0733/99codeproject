<GameFile>
  <PropertyGroup Name="allin_you" Type="Node" ID="ce1e5044-e8fc-4b4d-a218-fa5290fa8ff8" Version="3.10.0.0" />
  <Content ctype="GameProjectContent">
    <Content>
      <Animation Duration="18" Speed="0.5000" ActivedAnimationName="allin_yazhu">
        <Timeline ActionTag="1879929980" Property="Position">
        ...
        <Timeline ActionTag="1879929980" Property="Scale">
        ...
        <Timeline ActionTag="1879929980" Property="RotationSkew">
        ...
        <Timeline ActionTag="1879929980" Property="FileData">
          <TextureFrame FrameIndex="2" Tween="False">
            <TextureFile Type="Normal" Path="zhajinhua/image/animation/allin_shuangshou_9.png" Plist="" />
          </TextureFrame>
          <TextureFrame FrameIndex="4" Tween="False">
            <TextureFile Type="Normal" Path="zhajinhua/image/animation/allin_shuangshou_8.png" Plist="" />
          </TextureFrame>
          <TextureFrame FrameIndex="6" Tween="False">
            <TextureFile Type="Normal" Path="zhajinhua/image/animation/allin_shuangshou_8.png" Plist="" />
          </TextureFrame>
          <TextureFrame FrameIndex="8" Tween="False">
            <TextureFile Type="Normal" Path="zhajinhua/image/animation/allin_shuangshou_7.png" Plist="" />
          </TextureFrame>
          ...
          <TextureFrame FrameIndex="18" Tween="False">
            <TextureFile Type="Normal" Path="zhajinhua/image/animation/allin_shuangshou_10.png" Plist="" />
          </TextureFrame>
        </Timeline>
        <Timeline ActionTag="1879929980" Property="BlendFunc">
        ...
        <Timeline ActionTag="1879929980" Property="Alpha">
          <IntFrame FrameIndex="0" Value="255" />
          <IntFrame FrameIndex="14" Value="255" />
          <IntFrame FrameIndex="18" Value="255" />
        </Timeline>
        <Timeline ActionTag="1879929980" Property="FrameEvent">
          <EventFrame FrameIndex="2" Tween="False" Value="animation_move" />
          <EventFrame FrameIndex="18" Tween="False" Value="animation_endEnd" />
        </Timeline>
      </Animation>
      <AnimationList>
        <AnimationInfo Name="allin_yazhu" StartIndex="0" EndIndex="18">
          <RenderColor A="255" R="106" G="83" B="165" />
        </AnimationInfo>
        <AnimationInfo Name="allin_shouqian" StartIndex="25" EndIndex="45">
          <RenderColor A="255" R="231" G="48" B="249" />
        </AnimationInfo>
      </AnimationList>
      <ObjectData Name="Node" ctype="GameNodeObjectData">
        <Children>
          <AbstractNodeData Name="allin_qian_1_1" ActionTag="1879929980" Tag="2" IconVisible="True" LeftMargin="-182.5000" RightMargin="-182.5000" TopMargin="-144.0000" BottomMargin="-144.0000" FlipX="True" CascadeColorEnabled="True" CascadeOpacityEnabled="True" StretchWidthEnable="False" StretchHeightEnable="False" IntelliShadingEnabled="False" ctype="SpriteObjectData">
            <Size X="365.0000" Y="288.0000" />
            ...
            <FileData Type="Normal" Path="zhajinhua/image/animation/allin_shuangshou_10.png" Plist="" />
